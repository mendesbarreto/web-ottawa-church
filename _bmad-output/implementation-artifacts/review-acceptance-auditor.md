...
Review against the implementation spec and context docs. You may read the project files.
...
Check for deviations from acceptance criteria, rules, architecture decisions, UX intent, and implementation constraints. Return findings only. For each finding include severity, violated source, affected file/path, evidence, and a concrete fix direction.
